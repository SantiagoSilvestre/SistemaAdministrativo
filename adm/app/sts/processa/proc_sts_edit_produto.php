...
$SendStsEditproduto = filter_input(INPUT_POST, 'SendStsEditproduto', FILTER_SANITIZE_STRING);

if($SendStsEditproduto) {
    ...
    if($erro) {
        ...
        $result_edit_prod = "UPDATE sts_prods_homes SET
       ...
       mysqli_query($conn, $result_edit_prod);
        ...
        if(mysqli_affected_rows($conn)) {
            ...
            $destino = "../assets/imagens/prods_home/" . $dados_validos['id'] . "/";
