    ...
    <div class="d-flex">
        ...
        <div class="content p-1">
            <div class="list-group-item">
                ...
                ?>
                <form method="POST" action="<?= pg; ?>/processa/proc_sts_cad_cat_art">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>
                                <span tabindex="0" data-placement="top" data-toggle="tooltip" 
                                title="Categoria, auto-explicativo">
                    ...
                    <input name="SendStsCadCatArt" id="SendStsCadCatArt"  type="submit" class="btn btn-success" value="Cadastrar"></input>
                </form>
            </div>
        <?php  
