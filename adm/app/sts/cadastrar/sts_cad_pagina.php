            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Cadastrar Página STS</h2>
                    </div>
                    <div class="p-2">
                    <?php
                ...
                ?>
                <form method="POST" action="<?= pg; ?>/processa/proc_sts_cad_pagina" enctype="multipart/form-data">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="lib_bloq" id="lib_bloq" class="form-control">
                                <?php
                                    if (isset($_SESSION['dados']['lib_bloq']) && ($_SESSION['dados']['lib_bloq'] == '1')) {
                                        echo "<option value=''> Selecione</option>";
                                        echo "<option selected value='1'>Sim</option>";
                                        echo "<option value='2'>Não</option>";
                                    } else if(isset($_SESSION['dados']['lib_bloq']) && ($_SESSION['dados']['lib_bloq'] == '2')) {
                                        echo "<option value=''> Selecione</option>";
                    ...
                    <input name="SendStsCadPg" id="SendStsCadPg"  type="submit" class="btn btn-success" value="Cadastrar"></input>
                </form>
            </div>
        <?php  
